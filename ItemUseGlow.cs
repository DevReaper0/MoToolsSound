...
namespace MoToolsSound
{
    ...
    {
        public static readonly PlayerLayer ItemUseGlow = new PlayerLayer("MoToolsSound", "ItemUseGlow", PlayerLayer.HeldItem, delegate (PlayerDrawInfo drawInfo)
        {
            Player drawPlayer = drawInfo.drawPlayer;
            Mod mod = ModLoader.GetMod("MoToolsSound");
